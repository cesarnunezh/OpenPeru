...
class CongresistaDetail(BaseModel):
    id: int
    nombre: str
    leg_period: str
    party_name: str
...
def test_active_endpoint():
    ...
    request
    """
    response = client.get("/v1/congresistas/1109")
...
def test_invalid_path(congresista_id, response_code):
    ...
    """
    response = client.get(f"/v1/congresistas/{congresista_id}")
